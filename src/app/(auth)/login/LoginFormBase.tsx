...
// role prop을 받아 역할별 로그인 폼을 렌더링하는 공유 컴포넌트
...
const TAGLINE: Record<Role, { title: string; sub: string }> = {
  DRIVER: { title: '셔틀콕!', sub: '내 버스를 콕! 집어 관리하자' },
  PARENT: { title: '셔틀콕!', sub: '우리 아이 셔틀버스를 콕! 집어타자' },
}
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="text-center pt-2">
        {role === 'DRIVER' ? (
          <a
            href="/parent-login"
            className="flex min-h-[48px] items-center justify-center text-sm text-[#6C6C70] underline underline-offset-2"
          >
            학부모이신가요? 학부모 로그인
          </a>
        ) : (
